const commonFuncModule = (() => {
        let domElements = {};
            ...
            let $editBtn = domElements.editBtn;
        ...
        const saveElement = (optionTemplate, event) =>{
             ...
             let $inputElementParent = $inputElement.parent().parent(); // change this to closest with selector
             let $dropDownElement = $inputElementParent.siblings(formGroup).find('select');
             let $selectedOption = $dropDownElement.find('option:selected')
